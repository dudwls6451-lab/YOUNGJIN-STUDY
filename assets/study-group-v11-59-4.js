(() => {
              ...
              <section id="studyGroupGoalCard" class="study-group-goal-card">
                ...
                <form id="studyGroupGoalEditor" class="study-group-goal-form study-group-goal-editor hidden" novalidate>
                  ...
                  <div class="study-group-form-grid">
                    ...
                    <label id="studyGoalQuestionsWrap" class="hidden"><span>문제 풀이</span><div class="study-group-input-with-unit"><input id="studyGoalQuestions" type="number" min="1" max="10000" step="1" value="30"><span>문항</span></div></label>
  ...
  function updateGoalEditorFields(){
    ...
    const isTime=type==="study_time", isQuestions=type==="questions", isTheory=type==="theory_stage";
  ...
  async function saveGoal(e){
    ...
    if(type==="questions"&&(!Number.isFinite(questions)||questions<1||questions>10000)){alert("문제 풀이 목표를 1~10000문항 사이로 입력해 주세요.");return;}
