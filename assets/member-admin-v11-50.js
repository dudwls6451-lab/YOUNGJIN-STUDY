(() => {
  ...
  async function loadMembers() {
    ...
    const status=$("#memberManagementStatus"); if(status)status.textContent="회원 정보를 불러오는 중...";
    ...
    if(status)status.textContent=`전체 ${members.length}명`;
    renderMembers();
  }
