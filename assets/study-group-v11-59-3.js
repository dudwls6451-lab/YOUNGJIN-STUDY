(() => {
  ...
  function errText(error){
    ...
    if(/study_group_dashboard_v2|study_group_goals|study_group_board_|function .* does not exist|schema cache|PGRST202/i.test(msg)) return "스터디그룹 확장 DB가 아직 준비되지 않았습니다. Supabase SQL Editor에서 V11.59.3_STUDY_GROUP_DIRECT_GOAL_WRITE.sql까지 실행해 주세요.";
  ...
  async function saveGoal(e){
    ...
    const resolvedTitle=title||(type==="study_time"?"공부시간":type==="questions"?"문제 풀이":`${subject} 진도`);
