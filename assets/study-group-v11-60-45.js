/* PilotBank v11.60.45 — Study Group Question Lab */
(() => {
  "use strict";
  ...
  function errText(error){
    ...
    if(/study_group_dashboard_v2|study_group_goals|study_group_board_|study_group_question_|study_group_questions|function .* does not exist|schema cache|PGRST202/i.test(msg)) return "스터디그룹 확장 DB가 아직 준비되지 않았습니다. Supabase SQL Editor에서 V11.59.3_STUDY_GROUP_DIRECT_GOAL_WRITE.sql까지 실행해 주세요.";
